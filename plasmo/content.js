...
function isIgnoreElement() {
  ...
  //next.jsのドキュメント
  //classが"npm__react-simple-code-editor__textarea"の要素を取得
  const npm__react_simple_code_editor__textarea_elements =
    document.getElementsByClassName("npm__react-simple-code-editor__textarea")
  ...
  return Array.from(code_elements)
    ...
    .concat(Array.from(npm__react_simple_code_editor__textarea_elements))
}
